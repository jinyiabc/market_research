...
if __name__ == '__main__':
    ...
    for i in range(length):
        ...
        npvDate = today + ql.Period(1, ql.Years)
        # print(settelmentDate)
        fv_bond.append(ql.CashFlows.npv(leg, yts, True, settlement_date, npvDate))
        pv_bond.append(ql.CashFlows.npv(leg, yts, True, today, today))
    ...
    df2 = commercial_bank_chinabond.loc[:,
          ['Symbol', 'Latest Bond Rating', 'estimated_dirty_price_SHCH', 'Coupon Description', \
